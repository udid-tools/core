...
Use the matching issue form. Security vulnerabilities must be reported privately, not through public issues. New algorithms require the dedicated request form and must include motivation, standards/OIDs, key/container formats, test vectors, platform interoperability evidence, threat analysis, and migration impact.
